...
<body>
    ...
    <!-- Content -->
            <div class="col-md-9">
                ...
                <a href="tambah3.php"><i class="fas fa-plus-square"></i>Tambah data keuangani</a>
                <p class="lead"><center>
...
<table border="1" cellpadding="10" cellspacing="0">
    ...
    <tr>
    <td>
        <a href="ubah3.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin ubah data?');"><i class="fas fa-edit"></i> Ubah</a> 
    
                <a href="hapus3.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin hapus data?');"><i class="fas fa-trash-alt"></i> Hapus</a>
        </td>
        <td><?= $i; ?></td>
