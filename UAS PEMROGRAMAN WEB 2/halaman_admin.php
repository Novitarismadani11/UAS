...
<table border="1" cellpadding="10" cellspacing="0">
    ...
    <tr>
        <td>
        <a href="ubah.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin ubah data?');"><i class="fas fa-edit"></i> Ubah</a> 
    
                <a href="hapus.php?id=<?= $row["id"]; ?>" onclick="return confirm('Yakin hapus data?');"><i class="fas fa-trash-alt"></i> Hapus</a>
        </td>
        <td><?= $i; ?></td>
